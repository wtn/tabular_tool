...
class TestLint < Minitest::Test
  ...
  def test_helper_methods_are_private
    refute TabularTool::Operations::Lint.respond_to?(:check_blank_values)
    refute TabularTool::Operations::Lint.respond_to?(:check_duplicate_rows)
    refute TabularTool::Operations::Lint.respond_to?(:check_whitespace)
    refute TabularTool::Operations::Lint.respond_to?(:check_duplicate_column_values)
  end
